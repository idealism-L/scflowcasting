...
public class EtlHldFcstFg26wController extends BaseController {
    ...
    public R<EtlHldFcstFg26wVo> getInfo(@NotNull(message = "主键不能为空")
        ...
        return R.ok(iEtlHldFcstFg26wService.queryById(imMainInsuranceConfigId));
    }
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空")
        ...
        return toAjax(iEtlHldFcstFg26wService.deleteWithValidByIds(Arrays.asList(imMainInsuranceConfigIds), true));
    }
}
