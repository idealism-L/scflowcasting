...
public class TLogInterfaceCheckController extends BaseController {
    ...
    public R<TLogInterfaceCheckVo> getInfo(@NotNull(message = "主键不能为空")
        ...
        return R.ok(iTLogInterfaceCheckService.queryById(imMainInsuranceConfigId));
    }
    ...
    public R<Void> remove(@NotEmpty(message = "主键不能为空")
        ...
        return toAjax(iTLogInterfaceCheckService.deleteWithValidByIds(Arrays.asList(imMainInsuranceConfigIds), true));
    }
}
