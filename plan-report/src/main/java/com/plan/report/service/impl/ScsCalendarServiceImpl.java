...
public class ScsCalendarServiceImpl implements IScsCalendarService {
    ...
    private LambdaQueryWrapper<ScsCalendar> buildQueryWrapper(ScsCalendarBo bo) {
        ...
        lqw.eq(bo.getC4451pyDayDt() != null, ScsCalendar::getC445_1pyDayDt, bo.getC4451pyDayDt());
        lqw.eq(bo.getC4452pyDayDt() != null, ScsCalendar::getC445_2pyDayDt, bo.getC4452pyDayDt());
        lqw.eq(bo.getC4453pyDayDt() != null, ScsCalendar::getC445_3pyDayDt, bo.getC4453pyDayDt());
        lqw.eq(bo.getC4454pyDayDt() != null, ScsCalendar::getC445_4pyDayDt, bo.getC4454pyDayDt());
        lqw.eq(bo.getC4455pyDayDt() != null, ScsCalendar::getC445_5pyDayDt, bo.getC4455pyDayDt());
        ...
        lqw.eq(bo.getDailyConsumptionDays2py() != null, ScsCalendar::getDailyConsumptionDays_2py, bo.getDailyConsumptionDays2py());
        ...
        lqw.eq(bo.getDailyConsumptionDaysMtd2py() != null, ScsCalendar::getDailyConsumptionDaysMtd_2py, bo.getDailyConsumptionDaysMtd2py());
        ...
        lqw.eq(bo.getDailyConsumptionDaysQtd2py() != null, ScsCalendar::getDailyConsumptionDaysQtd_2py, bo.getDailyConsumptionDaysQtd2py());
        ...
        lqw.eq(bo.getDailyConsumptionDaysWtd2py() != null, ScsCalendar::getDailyConsumptionDaysWtd_2py, bo.getDailyConsumptionDaysWtd2py());
        ...
        lqw.eq(bo.getDailyConsumptionDaysYtd2py() != null, ScsCalendar::getDailyConsumptionDaysYtd_2py, bo.getDailyConsumptionDaysYtd2py());
        ...
        lqw.eq(bo.getWeeklyConsumptionDays2py() != null, ScsCalendar::getWeeklyConsumptionDays_2py, bo.getWeeklyConsumptionDays2py());
        lqw.eq(bo.getWeeklyConsumptionDays03mmt() != null, ScsCalendar::getWeeklyConsumptionDays_03mmt, bo.getWeeklyConsumptionDays03mmt());
        lqw.eq(bo.getWeeklyConsumptionDays03mmtPy() != null, ScsCalendar::getWeeklyConsumptionDays_03mmtPy, bo.getWeeklyConsumptionDays03mmtPy());
        lqw.eq(bo.getWeeklyConsumptionDays03mmt2py() != null, ScsCalendar::getWeeklyConsumptionDays_03mmt_2py, bo.getWeeklyConsumptionDays03mmt2py());
        lqw.eq(bo.getWeeklyConsumptionDays06mmt() != null, ScsCalendar::getWeeklyConsumptionDays_06mmt, bo.getWeeklyConsumptionDays06mmt());
        lqw.eq(bo.getWeeklyConsumptionDays06mmtPy() != null, ScsCalendar::getWeeklyConsumptionDays_06mmtPy, bo.getWeeklyConsumptionDays06mmtPy());
        lqw.eq(bo.getWeeklyConsumptionDays06mmt2py() != null, ScsCalendar::getWeeklyConsumptionDays_06mmt_2py, bo.getWeeklyConsumptionDays06mmt2py());
        lqw.eq(bo.getWeeklyConsumptionDays12mmt() != null, ScsCalendar::getWeeklyConsumptionDays_12mmt, bo.getWeeklyConsumptionDays12mmt());
        lqw.eq(bo.getWeeklyConsumptionDays12mmtPy() != null, ScsCalendar::getWeeklyConsumptionDays_12mmtPy, bo.getWeeklyConsumptionDays12mmtPy());
        lqw.eq(bo.getWeeklyConsumptionDays12mmt2py() != null, ScsCalendar::getWeeklyConsumptionDays_12mmt_2py, bo.getWeeklyConsumptionDays12mmt2py());
        lqw.eq(bo.getWeeklyConsumptionDays13wmt() != null, ScsCalendar::getWeeklyConsumptionDays_13wmt, bo.getWeeklyConsumptionDays13wmt());
        lqw.eq(bo.getWeeklyConsumptionDays13wmtPy() != null, ScsCalendar::getWeeklyConsumptionDays_13wmtPy, bo.getWeeklyConsumptionDays13wmtPy());
        lqw.eq(bo.getWeeklyConsumptionDays13wmt2py() != null, ScsCalendar::getWeeklyConsumptionDays_13wmt_2py, bo.getWeeklyConsumptionDays13wmt2py());
        lqw.eq(bo.getWeeklyConsumptionDays26wmt() != null, ScsCalendar::getWeeklyConsumptionDays_26wmt, bo.getWeeklyConsumptionDays26wmt());
        lqw.eq(bo.getWeeklyConsumptionDays26wmtPy() != null, ScsCalendar::getWeeklyConsumptionDays_26wmtPy, bo.getWeeklyConsumptionDays26wmtPy());
        lqw.eq(bo.getWeeklyConsumptionDays26wmt2py() != null, ScsCalendar::getWeeklyConsumptionDays_26wmt_2py, bo.getWeeklyConsumptionDays26wmt2py());
        lqw.eq(bo.getWeeklyConsumptionDays52wmt() != null, ScsCalendar::getWeeklyConsumptionDays_52wmt, bo.getWeeklyConsumptionDays52wmt());
        lqw.eq(bo.getWeeklyConsumptionDays52wmtPy() != null, ScsCalendar::getWeeklyConsumptionDays_52wmtPy, bo.getWeeklyConsumptionDays52wmtPy());
        lqw.eq(bo.getWeeklyConsumptionDays52wmt2py() != null, ScsCalendar::getWeeklyConsumptionDays_52wmt_2py, bo.getWeeklyConsumptionDays52wmt2py());
        ...
        lqw.eq(bo.getWeeklyConsumptionDaysMtd2py() != null, ScsCalendar::getWeeklyConsumptionDaysMtd_2py, bo.getWeeklyConsumptionDaysMtd2py());
        ...
        lqw.eq(bo.getWeeklyConsumptionDaysQtd2py() != null, ScsCalendar::getWeeklyConsumptionDaysQtd_2py, bo.getWeeklyConsumptionDaysQtd2py());
        lqw.eq(bo.getWeeklyConsumptionDaysWtdPy() != null, ScsCalendar::getWeeklyConsumptionDaysWtdPy, bo.getWeeklyConsumptionDaysWtdPy());
        lqw.eq(bo.getWeeklyConsumptionDaysWtd2py() != null, ScsCalendar::getWeeklyConsumptionDaysWtd_2py, bo.getWeeklyConsumptionDaysWtd2py());
        ...
        lqw.eq(bo.getWeeklyConsumptionDaysYtd2py() != null, ScsCalendar::getWeeklyConsumptionDaysYtd_2py, bo.getWeeklyConsumptionDaysYtd2py());
        ...
        lqw.eq(bo.getMonthlyConsumptionDays2py() != null, ScsCalendar::getMonthlyConsumptionDays_2py, bo.getMonthlyConsumptionDays2py());
        lqw.eq(bo.getMonthlyConsumptionDays03mmt() != null, ScsCalendar::getMonthlyConsumptionDays_03mmt, bo.getMonthlyConsumptionDays03mmt());
        lqw.eq(bo.getMonthlyConsumptionDays03mmtPy() != null, ScsCalendar::getMonthlyConsumptionDays_03mmtPy, bo.getMonthlyConsumptionDays03mmtPy());
        lqw.eq(bo.getMonthlyConsumptionDays03mmt2py() != null, ScsCalendar::getMonthlyConsumptionDays_03mmt_2py, bo.getMonthlyConsumptionDays03mmt2py());
        lqw.eq(bo.getMonthlyConsumptionDays06mmt() != null, ScsCalendar::getMonthlyConsumptionDays_06mmt, bo.getMonthlyConsumptionDays06mmt());
        lqw.eq(bo.getMonthlyConsumptionDays06mmtPy() != null, ScsCalendar::getMonthlyConsumptionDays_06mmtPy, bo.getMonthlyConsumptionDays06mmtPy());
        lqw.eq(bo.getMonthlyConsumptionDays06mmt2py() != null, ScsCalendar::getMonthlyConsumptionDays_06mmt_2py, bo.getMonthlyConsumptionDays06mmt2py());
        lqw.eq(bo.getMonthlyConsumptionDays12mmt() != null, ScsCalendar::getMonthlyConsumptionDays_12mmt, bo.getMonthlyConsumptionDays12mmt());
        lqw.eq(bo.getMonthlyConsumptionDays12mmtPy() != null, ScsCalendar::getMonthlyConsumptionDays_12mmtPy, bo.getMonthlyConsumptionDays12mmtPy());
        lqw.eq(bo.getMonthlyConsumptionDays12mmt2py() != null, ScsCalendar::getMonthlyConsumptionDays_12mmt_2py, bo.getMonthlyConsumptionDays12mmt2py());
        ...
        lqw.eq(bo.getMonthlyConsumptionDaysQtd2py() != null, ScsCalendar::getMonthlyConsumptionDaysQtd_2py, bo.getMonthlyConsumptionDaysQtd2py());
        ...
        lqw.eq(bo.getMonthlyConsumptionDaysYtd2py() != null, ScsCalendar::getMonthlyConsumptionDaysYtd_2py, bo.getMonthlyConsumptionDaysYtd2py());
        ...
        lqw.eq(bo.getQuarterlyConsumptionDays2py() != null, ScsCalendar::getQuarterlyConsumptionDays_2py, bo.getQuarterlyConsumptionDays2py());
        ...
        lqw.eq(bo.getQuarterlyConsumptionDaysYtd2py() != null, ScsCalendar::getQuarterlyConsumptionDaysYtd_2py, bo.getQuarterlyConsumptionDaysYtd2py());
        ...
        lqw.eq(bo.getYearlyConsumptionDays2py() != null, ScsCalendar::getYearlyConsumptionDays_2py, bo.getYearlyConsumptionDays2py());
