...
public class EtlClnItemBo extends BaseEntity {
     ...
     * 品牌+风味+包装描述2
     */
    @NotBlank(message = "品牌+风味+包装描述2不能为空", groups = { AddGroup.class, EditGroup.class })
     ...
     * u_createdate
     */
    @NotBlank(message = "u_createdate不能为空", groups = { AddGroup.class, EditGroup.class })
