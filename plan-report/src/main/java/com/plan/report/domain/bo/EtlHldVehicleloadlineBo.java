...
/**
 * 在途业务对象 etl_hld_vehicleloadline
 *
 * @author ruoyi
 * @date 2024-11-06
 */
...
public class EtlHldVehicleloadlineBo extends BaseEntity {
     ...
     * sourcestatus
     */
    @NotBlank(message = "sourcestatus不能为空", groups = { AddGroup.class, EditGroup.class })
